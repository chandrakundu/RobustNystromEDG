function X = SREDG_dist(E,F,r,RPCA, para)
    % SREDG_dist Sparse Robust Euclidean Distance Geometry algorithm for distance matrix completion
    % This does nystrom on D matrix. 
    %
    % Input:
